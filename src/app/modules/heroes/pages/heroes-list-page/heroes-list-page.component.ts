...
import { operationValidator } from 'src/app/shared/helpers/custom.validators';
...
export class HeroesListPageComponent implements OnInit {
  ...
  constructor(private heroService: HeroService,
    ...
    this.newHeroForm = this.formBuilder.group({
      ...
      operation: new FormControl('', [Validators.required, Validators.maxLength(30), operationValidator])
    });
    this.onChanges();
  }
